...
pub fn addSteps(
    ...
    const behaviour_suites = [_][]const u8{
        ...
        "tests/jzon/behaviour/serialize_test.zig",
        ...
        "tests/jzon/behaviour/deserialize_test.zig",
        "tests/jzon/behaviour/round_trip_test.zig",
        "tests/jzon/behaviour/strategy_pairs_test.zig",
    };
