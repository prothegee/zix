...
//!
//! zix.Http3 (.ASYNC), Router-only: pure-Zig QUIC on std.crypto
//! (RFC 9000/9001/9002/9114), a single worker on UDP 8443, one handler module
//! per route (src/handlers/). TLS 1.3 rides inside the handshake and ALPN h3
//! is negotiated by the engine. /static is served by the engine from
//! public_dir.
//!
//! Note:
