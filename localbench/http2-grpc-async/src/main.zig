//! localbench: zix-grpc
//!
//! zix.Grpc (.ASYNC) over h2c, one handler module per RPC (src/handlers/).
//! One accept thread hands each connection to a task, which multiplexes its h2
//! streams. Nothing is cached.
