...
| origin | zix.Http1 on `.URING`, cleartext, http1 re-originated to it | 127.0.0.1:18962 |
...
```bash
./scripts/localbench-build.sh gateway-uring
./scripts/localbench-validate.sh gateway-uring
./scripts/localbench-run.sh gateway-uring
```
