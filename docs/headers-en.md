...
See `examples/http_xtra_headers.zig` and `examples/http1_xtra_headers.zig` for a working demonstration of the cap, the overflow path, and the injection guard.
