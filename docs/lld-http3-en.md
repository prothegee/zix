...
The MAX_DATA (0x10) / MAX_STREAM_DATA (0x11) frame handling is in `dispatch/common.zig` (`applyStreamCredit`), and the rolling MAX_STREAMS credit is in `connection.zig` (`replenishBidiStreams`).
