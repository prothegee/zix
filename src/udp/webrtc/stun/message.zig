...
//! - Carries the two attribute codecs a binding transaction needs: XOR-MAPPED-ADDRESS (14.2) and
//!   FINGERPRINT (14.7).
//!
//! Note:
//! - This file is the container only. Which class may arrive, and what a server answers with, is
//!   the transaction's concern (see binding.zig).
...
/// Attribute type registry (RFC 8489 18.3). A type below 0x8000 is comprehension-required: a
/// receiver that does not understand it cannot process the message and must answer 420.
