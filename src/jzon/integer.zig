//! zix jzon integers, both directions.
//!
//! What:
...
test "zix jzon: both integer paths write the same digits" {
...
test "zix jzon: both integer paths write the extremes of their width" {
...
test "zix jzon: maxDigits bounds every width it is asked about" {
...
test "zix jzon: integer parse reads back what either path wrote" {
...
test "zix jzon: integer parse enforces the target type's range" {
...
test "zix jzon: integer parse rejects text no integer can be read from" {
